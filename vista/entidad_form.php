...
<div class="container">
    <div>
        <br>
        <h1 class="title">ENTIDAD QUE BRINDARA EL CURSO</h1>
        <h2 class="subtitle">Lista de entidades</h2>
        <hr class="division">
        <div class="buttons">
            <a class="button is-info" href="./index.php?mostrar=entidad_nuevo">
        ...
        <?php
            ...
            if (!isset($_SESSION['busqueda_modulo']) && empty($_SESSION['busqueda_modulo'])) {
                ...
                <?php
                    ...
                    $url = "index.php?mostrar=entidad_form&page=";
                    $registros = 15;
                    $busqueda = "";
                    require_once "./php/entidad_lista.php";
